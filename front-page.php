...
<?php get_template_part('partials/intro-section'); ?>
    ...
    <section class="features section-padding" id="features">
                        ...
                        <ul class="features-stack">
                            ...
                            <li class="feature-item">
                                ...
                                <div class="feature-content">
                                    ...
                                    <p>Your customers are in your own neighborhood. With local SEO techniques, we make you a star in your locations.</p>
                                </div>
                            </li>
                            <li class="feature-item">
                                <div class="feature-icon">
        ...
        <div class="responsive-feature-img"><img src="<?php echo get_template_directory_uri(); ?>/img/devices.png" alt="responsive devices"></div>
    </section>
    <section class="features-extra section-padding" id="assets">
        ...
        <div class="responsive-feature-img"><img src="<?php echo get_template_directory_uri(); ?>/img/macbook-pro.png" alt="responsive devices"></div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 col-xs-12 leftcol">
                    <h5>Photography</h5>
                    <p>One of the most important parts of a website, is quality photographs. What makes a website stand apart from 75% of the others is quality content and photography. Our photographers are experienced at working with plumbers, and making your staff feel comfortable during the shoot. </p>
                </div>
                        ...
                        <figure>
                            <a href="<?php echo get_template_directory_uri(); ?>/img/blog-img-01.jpg" class="single_image">
                                <div class="blog-img-wrap">
                                    ...
                                    <img src="<?php echo get_template_directory_uri(); ?>/img/blog-img-01.jpg" alt="Sedna blog image"/>
                                </div>
                            </a>
                            <figcaption>
                        ...
                        <figure>
                            <a href="<?php echo get_template_directory_uri(); ?>/img/blog-img-02.jpg" class="single_image">
                                <div class="blog-img-wrap">
                                    ...
                                    <img src="<?php echo get_template_directory_uri(); ?>/img/blog-img-02.jpg" alt="Plumber Marketing"/>
                                </div>
                            </a>
                            <figcaption>
                        ...
                        <figure>
                            <a href="<?php echo get_template_directory_uri(); ?>/img/blog-img-03.jpg" class="single_image">
                                <div class="blog-img-wrap">
                                    ...
                                    <img src="<?php echo get_template_directory_uri(); ?>/img/blog-img-03.jpg" class="single_image" alt="Sedna blog image"/>
                                </div>
                            </a>
                            <figcaption>
